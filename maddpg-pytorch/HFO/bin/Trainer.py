...
class Trainer(object):
  ...
  def createTeam(self, requested_team_name, play_offense):
    ...
    if requested_team_name == 'helios':
      ...
      team_name = 'HELIOS_17' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_16' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_15' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_14' + (' CLONE' if play_offense else '')
    ...
    if requested_team_name == 'helios':
      ...
      team_name = 'HELIOS_13' + (' CLONE' if play_offense else '')
      team_dir = os.path.join(teams_dir, 'helios', 'helios-13Eindhoven')
      lib_dir = os.path.join(teams_dir, 'helios', 'local', 'lib')
      return Teams.Helios(team_name, team_dir, lib_dir,
                          binaryName='helios_player', host='localhost',
      ...
      team_name = 'HELIOS_12' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_11' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_10' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_09' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_08' + (' CLONE' if play_offense else '')
      ...
      team_name = 'HELIOS_07' + (' CLONE' if play_offense else '')
