...
`PPO Algorithm <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/algorithms/PPOAlgorithm.py>`_
...
The `PPO Algorithm <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/algorithms/PPOAlgorithm.py>`_
is an `Algorithm <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/algorithms/Algorithm.py>`_
...
The `Imitation Agent <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/agents/ImitationAgent.py>`_
is an `Agent <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/agents/ImitationAgent.py>`_
