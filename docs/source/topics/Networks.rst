...
.. rubric:: `DynamicLinearNetwork class <https://github.com/nflux/Control-Tasks/blob/docs/shiva/shiva/networks/DynamicLinearNetwork.py>`_
...
* DynamicLinearSequential: creates a `torch.nn.Sequential <https://pytorch.org/docs/stable/nn.html#sequential>`_ with `linear transformations <https://pytorch.org/docs/stable/nn.html#linear>`_ on the incoming data.
