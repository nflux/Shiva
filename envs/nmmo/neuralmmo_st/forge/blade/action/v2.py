...
class Attack(action.Attack):
   ...
   def call(world, entity, targ, damageF, freeze=False):
      ### TEAM HIT OFF (hardcoded) ###
      # if ((entity.entID == targ.entID) or (entity.teamID == targ.teamID)):
         # print("[v2 - no attack]" + entity.entID + " and " + targ.entID + " are on same team.")
         # entity._attack = None
         # return
...
class Melee(action.Melee):
   ...
   def call(world, entity, targ):
      ...
      # if (targ.teamID != entity.teamID):
         # Attack.call(world, entity, targ, damageF)
      # else:
         # print("Same team! " + str(entity) + ":" + str(entity.entID) + " -- " + str(targ) + ":" + str(targ.entID))
