...
class RMADDPG(BASE_MADDPG):
    ...
    def update(self, team_sample=[], opp_sample=[], agent_i=0, side='team', parallel=False, logger=None, act_only=False, obs_only=False,
    ...
    def pretrain_critic(self, team_sample=[], opp_sample =[], agent_i = 0, side='team', parallel=False, logger=None, act_only=False, obs_only=False,forward_pass=True,load_same_agent=False,session_path="",lstm_burn_in=40):
        """
        Update parameters of agent model based on sample from replay buffer
        Inputs:
            sample: tuple of (observations, actions, rewards, next
    ...
    def pretrain_actor(self, team_sample=[], opp_sample =[], agent_i = 0, side='team', parallel=False, logger=None, act_only=False, obs_only=False,forward_pass=True,load_same_agent=False,session_path="",lstm_burn_in=40,burnin=False):
        """
