...
def parse_functions(package: str, funcs_str: List[str]) -> List[object]:
    """
    Is this being used?????
    ...
    """
    return [getattr(package, class_name, None) for class_name in funcs_str]

def DynamicLinearSequential(input_dim: int, output_dim: int, layers: List[int], activ_function: List[object], last_layer: bool, output_function: object=None) -> nn.Sequential:
    """
