...
class MultiAgentUnityWrapperEnv12(Environment):
    """ Unity Wrapper that supports MLAgents release 12
    ...
    def __init__(self, config):
        assert UnityEnvironment.API_VERSION == '1.3.0', "Using wrong version of UnityEnvironment"
        super(MultiAgentUnityWrapperEnv12, self).__init__(config)
