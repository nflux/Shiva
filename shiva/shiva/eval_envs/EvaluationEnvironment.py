...
def initialize_eval_env(env_params):
    ...
    if env_params['env_type'] == 'Gym':
        return GymEvaluationEnvironment(env_params['environment'], env_params['metrics_strings'], env_params['env_render'])
...
class GymEvaluationEnvironment(Environment.GymEnvironment):
    def __init__(self, eval_config, env_config):
        ...
        super(GymEvaluationEnvironment, self).__init__(env_config)
